...
| Asset | Value (R$) | Liquidity |
| --- | --- | --- |
| Apartment | 430,000 | Low (financed) |
| Stock portfolio (B3) | 137,398 | High |
...
(Durable rules — unchanged.)

- Don't let the zero-reserve state run past 6 months
- No new equity purchases before emergency reserve is built
- Don't accept relocation timing assuming <90-day apartment sale
- Don't treat [[Fluencypass]] equity as decision-grade net worth
